  ...
  return (
    <section className="relative overflow-hidden gradient-hero">
        ...
        <div className="text-center max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            <div className="flex items-center gap-2 bg-card/50 backdrop-blur-sm px-4 py-2 rounded-full border">
              ...
              <span className="text-sm font-medium">Emotional Safety</span>
            </div>
            <div className="flex items-center gap-2 bg-card/50 backdrop-blur-sm px-4 py-2 rounded-full border">
              <Users className="w-4 h-4 text-nordic-blue" />
              <span className="text-sm font-medium">Real Community</span>
            </div>
            <div className="flex items-center gap-2 bg-card/50 backdrop-blur-sm px-4 py-2 rounded-full border">
              <MapPin className="w-4 h-4 text-accent" />
              <span className="text-sm font-medium">Integration Support</span>
            </div>
          </div>
          ...
          <Button 
            ...
            size="lg" 
            className="bg-warmth hover:bg-warmth/90 text-warmth-foreground font-semibold px-8 py-6 text-lg rounded-xl transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
          >
            Join the Waitlist
      ...
      <div className="absolute top-0 left-0 w-full h-full opacity-50 pointer-events-none">
        <div className="absolute top-20 left-10 w-20 h-20 bg-nordic-blue/10 rounded-full blur-xl"></div>
        <div className="absolute top-40 right-20 w-32 h-32 bg-warmth/10 rounded-full blur-2xl"></div>
